...
SAMPLES <- c("P0_R4","P0_PERT2","P0_PERT3",
             ...
             "A2PT_R4","A1PT_PERT1","A5V2PT_PERT1","B1PT_PERT3","B2PT_PTX_Per3","B3PT_PTX_Per3")
CLASSES <- c(rep("parental",3),rep("untreated",9),rep("treated",6))
CLASSES_UNIQ <- c("parental","untreated","treated")

BOXPLOT <- "boxplot_GBC_count_treated_tumor_P0.pdf"
